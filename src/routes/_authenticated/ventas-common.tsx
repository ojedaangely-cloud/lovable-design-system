        ...
        {isEmployee ? (
          ...
          <Card className="lg:col-span-1 border border-border/80 shadow-sm">
            ...
            <CardContent className="space-y-4 pt-4">
              ...
              <UploadReceiptDialog userId={user?.id} restaurantBranch={branchKey} onSaved={load} />
            </CardContent>
          </Card>
        )}
              ...
              <Table className="min-w-[600px] sm:min-w-0 w-full">
                ...
                <TableBody>
                  ...
                  {filteredSales.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={5} className="text-center text-xs py-8 text-muted-foreground italic font-medium">
